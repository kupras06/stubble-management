...
'Access-Control-Allow-Headers': 'Content-Type, Authorization'
    ...
    // await axios.get(`${API_URL}stubble`).then((res) => console.log(res.json())).catch(err => console.log(err))
  }
  ...
  render() {
    ...
    return (
      <Container>
        {/* <Button onClick={() => this.setState({ loading: false })}>Stop</Button> */}
              ...
              <Card.Content>
                {loading ? (
                  ...
                  <>
                    ...
                    <Card.Description>Price : {stubble.price}</Card.Description>
                  </>
                )}
              </Card.Content>
