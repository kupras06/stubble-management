        ...
        return (
            <div>
               <Form loading={this.state.loading} onSubmit={this.formSubmit}>
                   <Form.Group>
                   <Form.Input type='password' name='old_password' label='Current Password' onClick={() => this.setState({message:false,error:false})}></Form.Input>
                   </Form.Group>
                   <Form.Group>
                   <Form.Input type='password' name='new_password' label='New Password' onClick={() => this.setState({error:false,message:false,})}></Form.Input>
                   <Form.Input type='password' name='new_password1' label='New Password Confirm' onClick={() => this.setState({error:false,message:false,})}></Form.Input>
                   </Form.Group>
                   <Form.Button type='submit' primary>Update Password </Form.Button>
               </Form>
